	...
	useAppTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"cloud:signIn": "Connect to Lite-Agent Cloud",
				"cloud:cloudBenefitsTitle": "Try Lite-Agent Cloud",
				...
				"cloud:visitCloudWebsite": "Visit Lite-Agent Cloud",
				"cloud:taskSync": "Task sync",
				"cloud:taskSyncDescription": "Sync your tasks for viewing and sharing on Lite-Agent Cloud",
				...
				"cloud:cloudUrlPillLabel": "Lite-Agent Cloud URL: ",
			}
...
describe("CloudView", () => {
	it("should display benefits when user is not authenticated", () => {
		...
		expect(screen.getByRole("heading", { name: "Try Lite-Agent Cloud" })).toBeInTheDocument()
	...
	it("should not display cloud URL pill when pointing to production", () => {
		...
		expect(screen.queryByText(/Lite-Agent Cloud URL:/)).not.toBeInTheDocument()
	})
	...
	it("should display cloud URL pill when pointing to non-production environment", () => {
		...
		expect(screen.getByText(/Lite-Agent Cloud URL:/)).toBeInTheDocument()
		expect(screen.getByText("https://app.roocode.com")).toBeInTheDocument()
	})
