 ...
 *
 * This class manages the state for the marketplace view in the Lite-Agent extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Lite-Agent extensions interface
